package harper.mapsmeproject.constants;
...
public class OSMConstants {
    ...
    public static final String PREFS_ORIENTATION_STRING = "orientationString";
    public static final String PREFS_ZOOM_LEVEL_STRING = "zoomLevelString";
